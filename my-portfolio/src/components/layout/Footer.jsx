    ...
    <footer className="relative py-12 overflow-hidden font-orbitron">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center md:text-left">
          ...
          {/* Column 3: Connect */}
          <div className="flex flex-col">
            <h3 className="text-[#a0b4cc] mb-4 text-lg">Connect</h3>
            <div className="flex flex-col md:flex-row md:justify-between items-center md:items-start space-y-2 md:space-y-0">
              {/* Social Icons */}
              <div className="flex space-x-4">
                <a 
            ...
            <div className="mt-6">
              <a 
                ...
                className="text-gray-400 hover:text-[#a0b4cc] transition-colors flex items-center justify-center md:justify-start space-x-2 group"
                aria-label="Email"
              >
                <Mail className="w-5 h-5 group-hover:scale-110 transition-transform" />
                <span>lhthenuwara@gmail.com</span>
              </a>
              <div className="text-gray-400 mt-4 text-sm flex items-center justify-center md:justify-start">
        ...
        {/* Bottom Line */}
        <div className="mt-12 pt-8 border-t border-[#2a3a50] flex justify-center">
          <p className="text-gray-500 text-xs text-center">
            Designed & built with <br />
            <span className="text-[#a0b4cc] px-1">React + Tailwind CSS</span>
          </p>
        </div>
      </div>
    </footer>
