            ...
            <div className="p-6 md:p-8 relative z-10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-y-4 gap-x-8">
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 rounded-full bg-[#a0b4cc]"></div>
                  <p className="text-gray-300">Member of IEEE club at IIT</p>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 rounded-full bg-[#a0b4cc]"></div>
                  <p className="text-gray-300">Member of RAS club at IIT</p>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 rounded-full bg-[#a0b4cc]"></div>
                  <p className="text-gray-300">Idealize 2024</p>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 rounded-full bg-[#a0b4cc]"></div>
                  <p className="text-gray-300">IEEE - Xtreme 2024</p>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 rounded-full bg-[#a0b4cc]"></div>
                  <p className="text-gray-300">Robotnexus 02</p>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 rounded-full bg-[#a0b4cc]"></div>
                  <p className="text-gray-300">Member of School Chess Team</p>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 rounded-full bg-[#a0b4cc]"></div>
                ...
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 rounded-full bg-[#a0b4cc]"></div>
                  <p className="text-gray-300">Codesprint</p>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 rounded-full bg-[#a0b4cc]"></div>
                  <p className="text-gray-300">Member of School Oratory and Debating Club</p>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 rounded-full bg-[#a0b4cc]"></div>
                  <p className="text-gray-300">Member of School Model United Nations Club</p>
                </div>
              </div>
            </div>
          </div>
